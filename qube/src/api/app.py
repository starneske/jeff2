...
from qube.src.api.jeff2controller import jeff2Controller
from qube.src.api.jeff2controller import jeff2ItemController
from qube.src.api.versioncontroller import jeff2ItemVersionController
...
api.add_resource(jeff2ItemVersionController, '/v1/jeff2/version')
api.add_resource(jeff2Controller, '/v1/jeff2')
api.add_resource(jeff2ItemController, '/v1/jeff2/<string:entity_id>')
